...
package testing.com.showcase_nav.materialTapTarget.extras;
...
import testing.com.showcase_nav.R;
import testing.com.showcase_nav.materialTapTarget.MaterialTapTargetPrompt;
import testing.com.showcase_nav.materialTapTarget.ResourceFinder;
import testing.com.showcase_nav.materialTapTarget.extras.backgrounds.CirclePromptBackground;
import testing.com.showcase_nav.materialTapTarget.extras.focals.CirclePromptFocal;
...
public class PromptOptions<T extends PromptOptions>
{
     ...
     */
    @ColorInt
    private int mPrimaryTextColour = Color.WHITE;
     ...
     */
    @ColorInt
    private int mFocalColour = Color.WHITE;
